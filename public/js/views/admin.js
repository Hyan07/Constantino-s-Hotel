...
async function settings() {
  ...
  adminShell(`<section class="card"><form id="settings-form">
    <div class="settings-section"><h2>Dados do hotel</h2><div class="form-grid">
      <div class="field"><label>Nome</label><input name="hotelName" value="${escapeHtml(hotel.name || "Constantino's Hotel")}" required></div>
      ...
      <p class="form-alert span-2">Essas informações aparecem no termo de hospedagem. Os horários de entrada/saída e o tempo estimado de limpeza devem ser informados ao hóspede. O aviso de privacidade ajuda a dar transparência ao tratamento dos dados.</p>
    </div></div>
